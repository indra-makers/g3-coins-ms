...
public class CoinApi {
	...
	public CoinApi(String id, String rank, String symbol, String name, Double supply, Double maxSupply,
			Double marketCapUsd, Double volumeUsd24Hr, Double priceUsd, Double changePercent24Hr, Double vwap24Hr,
			String explorer) {
		super();
		this.id = id;
		this.rank = rank;
	...
	public CoinApi(String symbol, String name) {
		super();
		this.symbol = symbol;
		this.name = name;
	}
